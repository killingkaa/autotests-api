...
def test_login():
    ...
    assert_equal(login_response_data.token.token_type,"bearer","token_type")
    assert_is_true(login_response_data.token.access_token, "access_token")
    assert_is_true(login_response_data.token.refresh_token, "refresh_token")
